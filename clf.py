...
import os
dir_black = os.path.join('Mel/Acral lentiginous')
dir_Cinder = os.path.join('Mel/Amelanotic')
dir_Laterite = os.path.join('Mel/Lentigo maligna')
dir_peat = os.path.join('Mel/Nodular melanoma')
dir_yellow = os.path.join('Mel/Normal')
...
Mel = load_model('best_model.hdf5')
class_names = sorted(os.listdir('Mel'))
class_names
['Acral lentiginous','Amelanotic','Lentigo maligna','Nodular melanoma','Normal']


def eval_model(model):
    class_names = ['Acral lentiginous','Amelanotic','Lentigo maligna','Nodular melanoma','Normal']
...
Mel=class_names[true_label]
print(Mel)
if Mel=="Acral lentiginous":
    messagebox.showinfo("Mel","Acral lentiginous")

if Mel=="Amelanotic":
    messagebox.showinfo("Mel", " Amelanotic")

if Mel=="Lentigo maligna":
    messagebox.showinfo("Mel", " Lentigo maligna")
if Mel=="Nodular melanoma":
    messagebox.showinfo("Mel", "Nodular melanoma")
if Mel=="Normal":
    messagebox.showinfo("Mel", " Normal.")